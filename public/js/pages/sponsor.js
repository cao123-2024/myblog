function render_sponsor() {
  ...
  titleSection.innerHTML =
    '<h1 style="font-size:2.8rem;font-weight:800;color:var(--text-primary);margin:0 0 8px;letter-spacing:4px">好活当赏</h1>' +
    '<p style="font-size:1.1rem;color:var(--text-secondary);margin:0">觉得这个项目不错？来赞助我吧！</p>';
  ...
  introCard.className = "card-glass";
  introCard.style.cssText = "padding:32px 28px;text-align:center;margin-bottom:20px";
  introCard.innerHTML =
    ...
    '</div>' +
    '<p style="font-size:1rem;line-height:1.8;color:var(--text-secondary);margin:0 auto;max-width:600px">' +
      'LUMINA 是一款开源的个人博客系统，致力于打造最优雅的写作与阅读体验。<br>' +
      '你的每一份赞助，都能帮助这个项目走得更远。<br>' +
      '感谢你的慷慨支持！' +
    '</p>' +
    '<div style="display:inline-flex;align-items:center;gap:8px;padding:10px 24px;background:rgba(0,120,212,0.1);border-radius:12px;margin-top:16px">' +
  ...
  whyCard.style.cssText = "padding:28px;margin-bottom:20px";
  whyCard.innerHTML =
