...
var PRESET_AVATARS = [
  ...
  { id:'av5',  name:'星星', svg:'<svg viewBox="0 0 100 100"><rect width="100" height="100" rx="50" fill="#1a0533"/><polygon points="50,12 61,42 93,42 67,62 77,93 50,73 23,93 33,62 7,42 39,42" fill="#FFD700"/><polygon points="50,12 61,42 93,42 67,62 77,93 50,73 23,93 33,62 7,42 39,42" fill="url(#starGrad)" opacity="0.3"/><defs><radialGradient id="starGrad"><stop offset="0%" stop-color="#fff"/><stop offset="100%" stop-color="#FFD700"/></radialGradient></defs></svg>' },
  { id:'av6',  name:'月亮', svg:'<svg viewBox="0 0 100 100"><rect width="100" height="100" rx="50" fill="#0D1B2A"/><circle cx="50" cy="50" r="32" fill="#F5F5DC"/><circle cx="40" cy="42" r="6" fill="#E8E0C8"/><circle cx="55" cy="58" r="4" fill="#E8E0C8"/><circle cx="48" cy="68" r="3" fill="#E8E0C8"/><circle cx="38" cy="55" r="2" fill="#E8E0C8"/><circle cx="60" cy="45" r="2.5" fill="#E8E0C8"/></svg>' },
  { id:'av7',  name:'小兔', svg:'<svg viewBox="0 0 100 100"><rect width="100" height="100" rx="50" fill="#FFB6C1"/><ellipse cx="50" cy="54" rx="26" ry="24" fill="#fff"/><ellipse cx="38" cy="12" rx="5" ry="20" fill="#fff"/><ellipse cx="62" cy="12" rx="5" ry="20" fill="#fff"/><ellipse cx="38" cy="8" rx="4" ry="14" fill="#FFB6C1"/><ellipse cx="62" cy="8" rx="4" ry="14" fill="#FFB6C1"/><ellipse cx="40" cy="50" rx="3" ry="4" fill="#333"/><ellipse cx="60" cy="50" rx="3" ry="4" fill="#333"/><ellipse cx="50" cy="58" rx="4" ry="3" fill="#FF69B4"/><line x1="44" y1="66" x2="46" y2="76" stroke="#fff" stroke-width="2"/><line x1="56" y1="66" x2="54" y2="76" stroke="#fff" stroke-width="2"/></svg>' },
  { id:'av8',  name:'小狐', svg:'<svg viewBox="0 0 100 100"><rect width="100" height="100" rx="50" fill="#FF6347"/><polygon points="50,18 30,42 50,48" fill="#fff"/><polygon points="50,18 70,42 50,48" fill="#fff"/><ellipse cx="50" cy="52" rx="26" ry="24" fill="#FF8C00"/><ellipse cx="40" cy="48" rx="4" ry="5" fill="#333"/><ellipse cx="60" cy="48" rx="4" ry="5" fill="#333"/><ellipse cx="50" cy="62" rx="12" ry="8" fill="#fff"/><circle cx="50" cy="62" r="3" fill="#333"/></svg>' },
  { id:'av9',  name:'熊猫', svg:'<svg viewBox="0 0 100 100"><rect width="100" height="100" rx="50" fill="#2d5016"/><ellipse cx="50" cy="52" rx="28" ry="26" fill="#fff"/><ellipse cx="36" cy="42" rx="10" ry="12" fill="#333"/><ellipse cx="64" cy="42" rx="10" ry="12" fill="#333"/><ellipse cx="36" cy="42" rx="5" ry="6" fill="#fff"/><ellipse cx="64" cy="42" rx="5" ry="6" fill="#fff"/><ellipse cx="50" cy="60" rx="8" ry="6" fill="#333"/><ellipse cx="50" cy="56" rx="3" ry="2" fill="#fff"/><circle cx="50" cy="68" r="2" fill="#333"/></svg>' },
  { id:'av10', name:'企鹅', svg:'<svg viewBox="0 0 100 100"><rect width="100" height="100" rx="50" fill="#87CEEB"/><ellipse cx="50" cy="54" rx="24" ry="28" fill="#2F4F4F"/><ellipse cx="50" cy="45" rx="20" ry="18" fill="#1a1a1a"/><ellipse cx="50" cy="50" rx="14" ry="12" fill="#fff"/><ellipse cx="44" cy="48" rx="3" ry="4" fill="#333"/><ellipse cx="56" cy="48" rx="3" ry="4" fill="#333"/><polygon points="46,54 54,54 52,58 48,58" fill="#FF6347"/><ellipse cx="36" cy="64" rx="5" ry="12" fill="#2F4F4F"/><ellipse cx="64" cy="64" rx="5" ry="12" fill="#2F4F4F"/></svg>' },
  { id:'av11', name:'花朵', svg:'<svg viewBox="0 0 100 100"><rect width="100" height="100" rx="50" fill="#F0FFF0"/><circle cx="50" cy="46" r="12" fill="#FFD700"/><ellipse cx="50" cy="30" rx="8" ry="14" fill="#FF69B4"/><ellipse cx="50" cy="30" rx="8" ry="14" fill="#FF69B4" transform="rotate(60,50,46)"/><ellipse cx="50" cy="30" rx="8" ry="14" fill="#FF69B4" transform="rotate(120,50,46)"/><ellipse cx="50" cy="30" rx="8" ry="14" fill="#FF69B4" transform="rotate(180,50,46)"/><ellipse cx="50" cy="30" rx="8" ry="14" fill="#FF69B4" transform="rotate(240,50,46)"/><ellipse cx="50" cy="30" rx="8" ry="14" fill="#FF69B4" transform="rotate(300,50,46)"/><line x1="50" y1="58" x2="50" y2="82" stroke="#32CD32" stroke-width="4"/><ellipse cx="42" cy="70" rx="10" ry="6" fill="#32CD32"/></svg>' },
  { id:'av12', name:'三叶草', svg:'<svg viewBox="0 0 100 100"><rect width="100" height="100" rx="50" fill="#F0FFF0"/><line x1="50" y1="58" x2="50" y2="82" stroke="#228B22" stroke-width="4"/><circle cx="50" cy="30" r="14" fill="#32CD32"/><circle cx="50" cy="30" r="10" fill="#90EE90"/><circle cx="32" cy="50" r="14" fill="#32CD32"/><circle cx="32" cy="50" r="10" fill="#90EE90"/><circle cx="68" cy="50" r="14" fill="#32CD32"/><circle cx="68" cy="50" r="10" fill="#90EE90"/></svg>' }
];
